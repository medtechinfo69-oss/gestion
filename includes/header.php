...
<head>
  ...
  <link rel="stylesheet"
    href="<?= e(APP_URL) ?>/assets/css/style.css?v=<?= defined('CACHE_VERSION') ? CACHE_VERSION : (int) filemtime(__DIR__ . '/../assets/css/style.css') ?>">
</head>
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="nav-group">
        ...
        <?php if (is_admin()): ?>
          ...
          <a href="<?= e(APP_URL) ?>/security_settings.php"
            class="nav-item <?= $activePage === 'security_settings' ? 'active' : '' ?>">
            <span class="ico" aria-hidden="true"><svg viewBox="0 0 24 24">
